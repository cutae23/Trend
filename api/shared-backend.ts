...
export const MOCK_NEWS_PLACES: Record<string, NewsPlace[]> = {
  "seoul": [
    {
      id: "s1",
      name: "자연도소금빵 성수점",
...
// Helper function to generate high-fidelity, customized dynamic mock places
export function generateDynamicMockPlaces(
  regionName: string,
  query: string,
  category: string
): NewsPlace[] {
